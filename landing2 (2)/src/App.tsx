...
const testimonials: TestimonialType[] = [
  ...
  },
  {
    id: 5,
    name: "Віктор П.",
    text: "Курс ����еревершив усі мої очікування. Рекомендую в��ім",
    videoId: "uVFR9LWXhaw",
    rating: 5,
  },
].map((testimonial) => ({
            ...
            <div className="space-y-8 sm:space-y-12">
              {[
                ...
                },
                {
                  ...
                  content:
                    "Використовуючи наш сайт, ви даєте згоду н�� збір та використання вашої інформації відповідно до даної політики.",
                  icon: "✅",
                },
                {
            ...
            <div className="mb-12 sm:mb-16">
              <div className="bg-gradient-to-br from-yellow-900/20 to-emerald-900/20 rounded-3xl p-6 sm:p-8 border border-yellow-500/30 backdrop-blur-sm shadow-xl">
                ...
                <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                  ...
                  уважно ознайомтеся з усіма пунктами пере��
                  початком навчання.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-8 sm:space-y-12">
              {[
                ...
                },
                {
                  ...
                  content:
                    "Обробка персональних даних здійснюється відповідно до ��олітики конфіденційнос��і.",
                  icon: "🔒",
